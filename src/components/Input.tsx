...
function Input() {
  ...
  return (
    ...
    no-scrollbar ${loading && "opacity-60"}`}
    >
      <img
      ...
      <div className="w-full divide-y divide-gray-700">
        <div className={`${selectedFile && "pb-7"} ${input && "space-y-2.5"}`}>
          <textarea
            ...
            rows="2"
            className="min-h-[60px] w-full bg-transparent text-white text-lg placeholder-[#6d6b6b99] outline-none tracking-wide no-scrollbar"
          ...
          {selectedFile && (
            <div className="relative">
              <div
                className="absolute w-8 h-8 bg-slate-500 hover:bg-gray-800
